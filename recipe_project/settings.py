...
ALLOWED_HOSTS = ['https://pkm-recipes-775734c521de.herokuapp.com', '127.0.0.1']
...
# Absolute path to directory where djangos collectstatic tool should search for static files 
